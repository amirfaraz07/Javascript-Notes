...
function add2nmbrs(n1, n2){ // giving parameters
    console.log(n1 + n2);
}
...
function add2nmbrs1(n1, n2){
 ...
 function loginUser(username){ // here we can also give some default value like (username = "faraz")
    if(username === undefined) { // here we can also use if(!username) it will also give same results
...
function cartPrice(val1, val2, ...n1){ // now here val1 takes 200 and val2 takes 400 and nums1 take other all
    return n1
}
